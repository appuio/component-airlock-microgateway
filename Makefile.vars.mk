...
COMPONENT_NAME ?= airlock-microgateway
...
instance ?= defaults
test_instances = tests/defaults.yml tests/multiple_instances.yml tests/live_example_dev.yml tests/sessionStoreMonitoring.yml tests/monitoring.yml
